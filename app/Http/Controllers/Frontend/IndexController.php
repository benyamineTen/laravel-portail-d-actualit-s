...
class IndexController extends Controller
{
    public function Index(){
        ...
        $newspopular = NewsPost::orderBy('id','DESC')->limit(8)->get();
        ...
        return view('frontend.index',compact('newnewspost','newspopular','skip_cat_0','skip_news_0','skip_cat_2','skip_news_2','skip_cat_1','skip_news_1','skip_cat_4'));
    } // End Method 
