...
<img width="700" height="400" src="" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" loading="lazy">
...
<h4 class="tab_hadding"><a href="{{ url('news/details/'.$item->id.'/'.$item->news_title_slug) }}">
     </a></h4>
</div>
@endforeach
...
<a href="{{ url('news/details/'.$item->id.'/'.$item->news_title_slug) }}"><img class="lazyload" src="{{ asset($item->image) }}"  ></a>
<a href=" " class="tab-icon"><i class="la la-play"></i></a>
<h4 class="tab_hadding"><a href="{{ url('news/details/'.$item->id.'/'.$item->news_title_slug) }}"></a></h4>
</div>
@endforeach
...
<h2 class="themesBazar_cat01"> <a href=" "> </a> <span> <a href=""> More <i class="las la-arrow-circle-right"></i> </a></span> </h2>
...
<a href=" "><img class="lazyload" src=""  ></a> <a href=" " class="video-icon6"><i class="la la-play"></i></a>
</div>
